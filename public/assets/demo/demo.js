demo = {
    ...
    initDashboardPageCharts: function(avgFillLevel, dateLabels, statusCount, avgVoltage, avgCurrent, avgPower, avgTemperature, avgGenStatus) {
        ...
        ctx = document.getElementById('voltageChart').getContext("2d");
        ...
        ctx = document.getElementById('currentChart').getContext("2d");
        ...
        ctx = document.getElementById('genChart').getContext("2d");
